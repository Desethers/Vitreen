...
const VARIATIONS = [
  {
    name: "1-bleu-nuit",
    prompt:
      "Change the color of the large canvas painting on the wall to a deep midnight blue (#1a237e). Keep every other element exactly the same: white gallery walls, polished concrete floor, ceiling spotlights, same composition. Only the paint color on the canvas changes.",
  },
  {
    name: "2-vert-foret",
    prompt:
      "Change the color of the large canvas painting on the wall to a dark forest green (#1b5e20). Keep every other element exactly the same: white gallery walls, polished concrete floor, ceiling spotlights, same composition. Only the paint color on the canvas changes.",
  },
  {
    name: "3-noir-charbon",
    prompt:
      "Change the color of the large canvas painting on the wall to matte charcoal black (#212121). Keep every other element exactly the same: white gallery walls, polished concrete floor, ceiling spotlights, same composition. Only the paint color on the canvas changes.",
  },
  {
    name: "4-ocre-or",
    prompt:
      "Change the color of the large canvas painting on the wall to warm ochre gold (#f57f17). Keep every other element exactly the same: white gallery walls, polished concrete floor, ceiling spotlights, same composition. Only the paint color on the canvas changes.",
  },
  {
    name: "5-blanc-ivoire",
    prompt:
      "Change the color of the large canvas painting on the wall to pure ivory white (#fafafa). Keep every other element exactly the same: white gallery walls, polished concrete floor, ceiling spotlights, same composition. Only the paint color on the canvas changes.",
  },
];
