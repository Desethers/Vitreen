...
export const translations = {
  fr: {
    ...
    services: {
      title: "Pricing",
      subtitle:
        "Designed for independent galleries, growing teams and complex operations.",
      items: [
        {
          tier: "EXISTING SETUP",
          name: "Website Deployment",
          description:
            "For galleries that need a website connected to their artworks.",
          ...
          priceSecondary: "+ one-time deployment fee",
          priceNote: "Website design, artwork migration and publishing setup.",
        ...
        },
        {
          ...
          description:
            "For galleries that want artworks, publishing and collector communication connected together.",
          featuresHeading: "Included:",
          features: [
            "Artlogic / CSV / spreadsheet connection",
            "Gmail integration",
            "Collector PDFs",
            "Inquiry tracking",
          ...
          priceSecondary: "+ one-time deployment fee",
          priceNote: "Integrations, workflow mapping and collector communication setup.",
        ...
        },
        {
          ...
          description:
            "For galleries with specific workflows, teams or sales processes.",
          featuresHeading: "Included:",
          features: [
            ...
            "AI gallery assistants",
            "Ongoing operational support",
          ],
          delivery: undefined as string | undefined,
          price: "Custom pricing",
          priceSecondary: "+ custom deployment fee",
          priceNote: "Tailored infrastructure, advanced workflows and operational support.",
