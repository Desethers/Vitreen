      ...
      items: [
        {
          ...
          features: [
            ...
            "Saisie simple des œuvres (images + texte uniquement)",
            "Liens de partage privés (email, WhatsApp, direct)",
            "Présentation haut de gamme (aucun effet template)",
            "Publication rapide — sans configuration, sans système à gérer",
          ],
          delivery: "Livraison : 5 jours ouvrés",
          price: "29 € / mois",
          priceNote: "Abonnement mensuel · annulez à tout moment",
          cta: "Commencer",
      ...
      items: [
        {
          ...
          features: [
            ...
            "Simple artwork input (images + text only)",
            "Private shareable links (email, WhatsApp, direct)",
            "Clean, high-end presentation (no templates feel)",
            "Fast publishing — no setup, no system to manage",
          ],
