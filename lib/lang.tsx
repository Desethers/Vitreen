      ...
      items: [
        {
          tier: "PORTFOLIO",
          name: "Artist Studio",
          description: "Un studio digital raffiné pour artistes indépendants — présentez votre travail, gérez votre archive, connectez-vous avec vos collectionneurs.",
          featuresHeading: "Inclus :",
          features: ["Site rapide & responsive", "Pages essentielles", "Contact sur chaque œuvre", "SEO de base", "Dashboard privé archive & demandes"],
        ...
        },
        {
          ...
          featuresHeading: "Inclus :",
          features: ["Catalogue illimité", "Structure galerie complète", "Parcours orienté collectionneur", "Inquiry system optimisé", "SEO marché de l\u2019art", "Gallery OS privé : base de données & ventes"],
    ...
    statementSplit: {
      ...
      blocks: [
        ...
        },
        {
          ...
          body2: "Chaque interaction accompagne un glissement progressif — de la découverte vers l\u2019engagement, et de l\u2019attention vers une relation durable avec le travail de l\u2019artiste.",
        },
        {
      ...
      items: [
        {
          tier: "PORTFOLIO",
          name: "Artist Studio",
          description: "A refined digital studio for independent artists — present your work, manage your archive, connect with collectors.",
          featuresHeading: "Included:",
          features: ["Fast & responsive website", "Core pages (artist, exhibitions, texts)", "Contact on each artwork", "Basic SEO", "Private dashboard for archive & enquiries"],
        ...
        },
        {
          ...
          featuresHeading: "Included:",
          features: ["Unlimited catalogue", "Complete gallery structure", "Collector-oriented journey", "Optimised inquiry system", "Art market SEO", "Private gallery OS for database & enquiries"],
    ...
    statementSplit: {
      ...
      blocks: [
        ...
        },
        {
          ...
          body2: "Every interaction supports a gradual shift from discovery to engagement, and from attention to a sustained relationship with the work.",
        },
        {
