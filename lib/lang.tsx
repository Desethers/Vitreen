  ...
  fr: {
    nav: {
      ...
      productMenu: {
        ...
        items: [
          { title: "Artworks & Archives", desc: "Organisez œuvres, expositions et archives à travers vos systèmes existants.", href: "/tools/archive" },
  ...
  en: {
    nav: {
      ...
      productMenu: {
        ...
        items: [
          { title: "Artworks & Archives", desc: "Organise artworks, exhibitions and gallery archives across existing systems.", href: "/products/artworks-archives" },
