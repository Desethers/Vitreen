...
const services: Service[] = [
  {
    ...
    features: [
      "Site responsive & moderne (jusqu'à 10 sections)",
      "Catalogue d'œuvres (jusqu'à 30 œuvres)",
      "Optimisation images & chargement rapide",
      "Formulaire de contact / Inquiry sur chaque œuvre",
      "SEO de base optimisé",
      "Design sur mesure léger",
...
export default function Services() {
  return (
    <section id="offre" className="pt-12 md:pt-[46px] pb-12 md:pb-[46px] px-4 md:px-6 bg-white">
