        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-2.5">
              ...
              <input className={inputCls} placeholder="Inquiry email / contact" value={setup.galleryContact} onChange={e => set('galleryContact', e.target.value)} />
    ...
    <footer className="bg-white px-6 py-8 text-gray-950 dark:bg-[#111111] dark:text-gray-100 sm:px-10">
      <div className="mx-auto w-full max-w-5xl">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <p className="text-[11px] font-medium uppercase tracking-[0.16em] text-gray-400 dark:text-gray-500">Product</p>
            <div className="mt-3 space-y-2 text-[13px] text-gray-500 dark:text-gray-400">
              <a href="/viewing-room-studio/editor" className="block transition-colors hover:text-gray-950 dark:hover:text-gray-100">Editor</a>
              <a href="/viewing-room-studio/dashboard" className="block transition-colors hover:text-gray-950 dark:hover:text-gray-100">Dashboard</a>
              <a href="/viewing-room-studio/room" className="block transition-colors hover:text-gray-950 dark:hover:text-gray-100">Preview</a>
            </div>
          </div>

          <div>
            <p className="text-[11px] font-medium uppercase tracking-[0.16em] text-gray-400 dark:text-gray-500">Contact</p>
            <div className="mt-3 space-y-2 text-[13px] text-gray-500 dark:text-gray-400">
              <a href="mailto:vitreen@proton.me" className="block transition-colors hover:text-gray-950 dark:hover:text-gray-100">contact@viewingroom.studio</a>
  ...
  if (!hydrated) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-[#111111] px-6">
        <p className="text-[11px] uppercase tracking-[0.3em] text-gray-400 dark:text-gray-600 mb-5">Viewing Room Studio</p>
  ...
  return (
      ...
      <div className="fixed right-3 top-3 z-30 flex items-center gap-2 vr-shell-fade md:right-4 md:top-4">
        {clerkEnabled && (
          isSignedIn
            ? (
              <a href="/viewing-room-studio/dashboard" className="inline-flex h-8 items-center rounded-[5px] border border-gray-200 bg-white/90 px-3 text-[12px] text-gray-700 transition-colors hover:border-gray-300 hover:text-gray-950 dark:border-gray-800 dark:bg-[#1c1c1c]/90 dark:text-gray-200 dark:hover:border-gray-700">
                Dashboard
              </a>
            )
            : <a href="/viewing-room-studio/sign-in" className="inline-flex h-8 items-center rounded-[5px] bg-gray-900 px-4 text-[12px] text-white transition-colors hover:bg-gray-700">Sign in</a>
        )}
        <ThemeToggle />
      </div>
