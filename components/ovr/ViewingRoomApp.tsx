      ...
      {clerkEnabled && (
        <div className="hidden lg:flex absolute top-4 right-5 z-20 items-center gap-2">
          {isSignedIn
            ...
            : <a href="https://vitreen.art/sign-in?redirect_url=https://room.vitreen.art/editor" className="cursor-pointer text-xs text-white bg-gray-900 hover:bg-gray-700 transition-colors px-5 py-2.5 rounded-[5px]">Sign in</a>
          }
        </div>
      )}
