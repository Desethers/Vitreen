...
const TOOLS_ITEMS = [
  {
    ...
    desc: "Organisez les œuvres, artistes et fiches.",
    href: "/fr/tools/archive",
  },
  {
    title: "Assistant galerie",
    desc: "Préparez le contenu et le travail quotidien.",
    href: "/fr/tools/custom-operations",
  },
  {
    title: "Viewing Rooms",
    desc: "Créez et partagez des sélections privées.",
    ...
    <>
      <header
        className={`fixed left-0 right-0 top-0 z-50 border-b-[0.5px] bg-white px-4 py-2 transition-[border-color] duration-200 md:px-6 ${
          scrolled || toolsOpen ? "border-[#E8E8E6]" : "border-transparent"
        }`}
      >
            ...
            >
              <div className="w-full border-b border-[#E8E8E6] bg-white px-8 py-8">
                <div className="mx-auto grid max-w-7xl grid-cols-[1fr_minmax(0,32rem)] gap-x-12">
                  <div>
                    <p className="text-[12px] text-[#ADADAA]">Outils</p>
