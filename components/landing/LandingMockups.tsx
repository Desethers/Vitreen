...
export function ConnectedFlowDiagram() {
  const sources = ["Artlogic", "CSV / spreadsheets", "Existing database"];
  const outputs = ["Gmail", "WhatsApp", "Private links", "PDFs"];
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="w-full rounded-[12px] border border-[#111110] bg-[#111110] px-5 py-4 text-center md:px-8 md:py-5">
        <p className="font-display text-[16px] tracking-[-0.02em] text-white md:text-[20px]">
          Vitreen artwork layer
        </p>
        <p className="mt-1 text-[12px] text-white/60 md:text-[13px]">
          Artworks, artists, images, dimensions, prices, availability, documents
        </p>
      </div>
