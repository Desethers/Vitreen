...
import { BODY, H2 } from "@/components/landing/styles";
...
function DropFileMockup() {
  return (
    <div className="mx-auto w-full max-w-[320px] rounded-[16px] border border-[#E4E4E7] bg-white p-5">
      <PanelHeader title="Import a file" />
      <p className="mt-1 text-[10px] text-[#ADADAA]">Bring your whole inventory from a CSV file</p>

      <div className="mt-4 flex h-[110px] flex-col items-center justify-center rounded-[10px] border-2 border-dashed border-[#E4E4E7] text-center">
        <UploadIcon />
      ...
      <p className="mt-3 text-[10px] text-[#6B6A67] underline underline-offset-2">
...
function ImportPreviewMockup() {
  return (
    <div className="mx-auto w-full max-w-[320px] rounded-[16px] border border-[#E4E4E7] bg-white p-5">
      ...
      <div className="mt-4 flex items-center justify-between rounded-[8px] border border-[#E4E4E7] px-3 py-2 text-[10px] text-[#6B6A67]">
        <span>▧ inventory-template.csv</span>
        <span className="text-[#ADADAA]">×</span>
      </div>

      <p className="mt-2.5 flex items-center gap-1.5 text-[10px] text-[#168044]">
      ...
      <div className="mt-2 overflow-hidden rounded-[8px] border border-[#E4E4E7]">
  ...
  return (
    <section className="border-t border-[#E8E8E6] bg-white px-4 py-14 md:px-6 md:py-[72px]">
      <div className="mx-auto w-full max-w-7xl text-center">
        <h2 className={`${H2} mx-auto max-w-2xl`}>Bring your artwork inventory into Vitreen.</h2>
