...
const MESSAGES = [
  {
    ...
    color: "#6B7FD7",
    name: "Marie Chen",
    subject: "Availability — Night Garden IV",
    time: "10:24 AM",
    body: "Is Night Garden IV still available?",
  },
  {
    initials: "TB",
    color: "#C97B4A",
    ...
    time: "Yesterday",
    body: "Could you send the price and dimensions for Soft Power I?",
  },
  {
    initials: "LM",
    color: "#4E9C82",
    ...
    time: "2 days ago",
    body: "Do you have any other works by this artist available now?",
  },
] as const;
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10.5px] text-[#5F6368]">to me</p>
            </div>
          </div>
