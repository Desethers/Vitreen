...
const TOOLS_ITEMS = [
  {
    ...
    desc: "Organise artworks, artists and records.",
    href: "/tools/archive",
  },
  {
    title: "Gallery Assistant",
    desc: "Prepare content and daily gallery work.",
    href: "/tools/custom-operations",
  },
  {
    title: "Viewing Rooms",
    desc: "Create and share private selections.",
            ...
            >
              <div className="w-full border-b border-[#E8E8E6] bg-white px-8 py-8">
                <div className="mx-auto grid max-w-7xl grid-cols-[1fr_minmax(0,32rem)] gap-x-12">
                  <div>
                    <p className="text-[12px] text-[#ADADAA]">Tools</p>
