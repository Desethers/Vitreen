...
/**
 * Same structure and type scale as the main site's Hero.tsx: eyebrow, H1 at
 * text-[22px] md:text-[30px] with tracking-[-0.04em], subtitle inheriting
 * that size in muted grey, left-aligned, same vertical rhythm.
 */
export default function LandingHero() {
  return (
    <section className="relative flex flex-col overflow-hidden bg-white px-4 pb-10 pt-36 md:px-6 md:pb-14 md:pt-44">
      <div className="relative mx-auto w-full max-w-7xl text-[22px] leading-[1.3] md:text-[30px]">
        ...
        <h1
          className="hero-fade-up m-0 max-w-4xl text-balance leading-[inherit] tracking-[-0.04em] font-display md:max-w-5xl"
          style={{ color: "#111110" }}
        >
          We build better tools for gallery sales.
        </h1>

        <p className="hero-fade-up hero-fade-up-delay mt-[16px] max-w-3xl leading-[inherit] tracking-[-0.02em] text-[#6B6A67]">
