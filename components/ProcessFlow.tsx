    ...
    <section id="solutions" className="pt-12 md:pt-[60px] pb-12 md:pb-[60px] px-4 md:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={ref}>
          ...
          <motion.ol {...fadeUp(0.1)} className="m-0 flex list-none flex-col gap-0 p-0 md:hidden">
            {steps.map((step, i) => (
              <li key={step.number} className="flex gap-4">
                ...
                <motion.div
                  className={
                    i < steps.length - 1 ? "min-w-0 flex-1 pt-0.5 pb-10" : "min-w-0 flex-1 pt-0.5"
                  }
            ...
            <ol className="m-0 grid list-none grid-cols-3 gap-10 p-0">
              {steps.map((step, i) => (
                <motion.li
                  ...
                  transition={{ duration: 0.5, ease: "easeOut" }}
                >
                  <p className="font-normal text-base text-[#111110] tracking-[-0.02em] mb-0">
                    {step.title}
                  </p>
                  <p className="mt-2 text-[14px] leading-[1.6] text-[#425466]">{step.desc}</p>
                  <p className="mt-4 text-[11px] uppercase tracking-[0.08em] text-[#ADADAA]">
                    {step.week}
                  </p>
                </motion.li>
              ))}
