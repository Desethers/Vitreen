...
export default function CtaBand() {
  return (
    <section className="relative py-12 px-4 md:px-6 overflow-hidden bg-[var(--background)]">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="rounded-[28px] md:rounded-[32px] bg-[#000000] px-6 py-16 md:px-12 md:py-20 lg:py-24"
        >
