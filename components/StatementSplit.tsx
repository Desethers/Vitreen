...
const BLOCK_ICONS = [
  ...
  >
    <path
      d="M8 2L3 4.5V8C3 11.5 5.5 13.8 8 14.5C10.5 13.8 13 11.5 13 8V4.5L8 2Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div {...fadeUp(0.06)} className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {t.statementSplit.stats.map((m) => (
              <div
                key={m.value}
                className="flex flex-col justify-between min-h-[260px] md:min-h-[320px] px-6 py-8 md:px-8 md:py-10 border border-[#111110]/14 rounded bg-white/10 transition-all duration-200 hover:border-[#111110]/28 hover:bg-white/22"
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[11px] font-normal leading-snug text-[#111110]/58 tracking-[-0.01em]">
                    {m.sub}
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
              {t.statementSplit.blocks.map((block, i) => (
                <div key={i} className="flex flex-col gap-4">
                  ...
                  <p className="text-[15px] text-[#111110]/72 leading-relaxed tracking-[-0.01em]">
