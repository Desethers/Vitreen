...
export function ArtistPageMock({ isMobile = false }: { isMobile?: boolean }) {
          ...
          <div className="px-5 pt-5 pb-10">
              ...
              <div className="flex flex-col gap-6">
                {artworks.map((src, i) => (
                  <div key={i} className="flex flex-col gap-2">
                    <div
                      className="rounded overflow-hidden bg-[#E8E4DF] relative"
                      style={{ height: 240 }}
                    >
                      <Image
                        src={src}
                        alt={artworkMeta[i].title}
                        fill
            ...
            {activeTab === "Biography" && (
              <p className="text-[13px] text-[#444] leading-[1.7]">
                Sacha Elron (born 1960 in Oklahoma) is an American painter known for his
                large-scale, meditative landscapes. His work has been exhibited internationally and
            ...
            {activeTab === "Exhibitions" && (
              <div className="flex flex-col gap-5">
                {[
                  {
                    img: "/artist page/exhibition5.jpg",
                    title: "Recent Studies",
                    location: "Paris, Turenne",
                    dates: "Jan 12 — Feb 22, 2026",
                  },
                  {
                    img: "/artist page/Exhibition6.png",
                    title: "Your friends",
                    location: "London",
                    dates: "Oct 05 — Nov 28, 2025",
                  },
                ].map((e) => (
            ...
            {(activeTab === "News" || activeTab === "Press") && (
              <div className="flex flex-col divide-y divide-[#E8E4DF]">
                {[
                  ...
                  "The Art Newspaper — October 2023",
                  "Frieze — September 2023",
                ].map((n) => (
                  <p key={n} className="text-[12px] text-[#333] py-3">
                    {n}
                  </p>
                ))}
              </div>
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-[15px] font-semibold text-[#111110] leading-tight">
                  Sacha Elron
                </h2>
            ...
            <div className="flex flex-col gap-2.5">
              {t.showcase.bio.map((p, i) => (
                <p key={i} className="text-[10px] text-[#444] leading-[1.7]">
                  {p}
                </p>
              ))}
            </div>
      ...
      <div style={{ zoom: 0.58 }} className="font-sans text-[#111110]">
          ...
          <div
            ...
            style={{
              ...
              background: artistScrolled
                ...
                : "transparent",
              backdropFilter: artistScrolled
                ? "blur(40px) saturate(2) brightness(1.05) contrast(0.98)"
                : "none",
              WebkitBackdropFilter: artistScrolled
                ? "blur(40px) saturate(2) brightness(1.05) contrast(0.98)"
                : "none",
        ...
        <div className="flex gap-12 px-12 pt-10 pb-8">
          <div
            className="w-[300px] shrink-0 rounded overflow-hidden bg-[#C8C0B8] relative"
            style={{ height: 390 }}
          >
            <Image
              src="/artist page/sundog.png"
          ...
          <div className="flex flex-col gap-3 pt-2 min-w-0">
            ...
            <p className="text-[14px] text-[#444] leading-[1.65] max-w-[520px] mt-1">
              Sacha Elron explores the boundaries of landscape and abstraction through a deeply
              personal visual vocabulary. His paintings, often rendered in rich, saturated color
              fields, evoke a contemplative stillness that hovers between representation and pure
              sensation.
            </p>
            <p className="text-[14px] text-[#444] leading-[1.65] max-w-[520px]">
              ...
              essential forms — solitary trees, expansive skies, and luminous horizons emerge from
              layers of pigment with an almost meditative quality.
            </p>
            <button
              onClick={() => setBioOpen(true)}
        ...
        <div className="border-t border-[#E8E4DF] mx-12 pt-5 pb-4 flex items-center justify-between">
          <p className="text-[11px] uppercase tracking-[0.12em] text-[#ADADAA] font-medium">
            Selected Works
          </p>
        ...
        <div className="px-12 pb-10">
          ...
          {activeTab === "Biography" && (
            <p className="text-[14px] text-[#444] leading-[1.7] max-w-2xl">
              Sacha Elron (born 1960 in Oklahoma) is an American painter known for his large-scale,
              meditative landscapes. His work has been exhibited internationally and is held in
              numerous public and private collections. He lives and works in New York City, where he
              maintains a studio in Brooklyn.
            </p>
          )}
          {activeTab === "Exhibitions" && (
            <div className="grid grid-cols-3 gap-5">
              {[
                ...
                {
                  img: "/artist page/Exhibition8.png",
                  title: "Quiet Paintings",
                  location: "New York",
                  dates: "Mar 10 — Apr 30, 2025",
                },
              ].map((e) => (
          ...
          {(activeTab === "News" || activeTab === "Press") && (
            <div className="flex flex-col divide-y divide-[#E8E4DF]">
              {[
                ...
                <p key={n} className="text-[13px] text-[#333] py-3">
                  {n}
                </p>
              ))}
            </div>
