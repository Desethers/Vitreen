      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl text-[#111110] leading-tight tracking-tight max-w-2xl">
            Une interface pensée pour le fonctionnement réel du monde de l'art.
          </h2>
          <p className="mt-4 text-[#6B6A67] text-base max-w-xl leading-relaxed">
            Que vous soyez une galerie, artiste, art advisor ou gestionnaire de collection privée, Vitreen vous permet de publier, présenter et diffuser vos œuvres avec simplicité et élégance.
          </p>
        </motion.div>
