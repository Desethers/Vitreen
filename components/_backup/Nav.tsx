...
export default function Nav() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center py-4 px-8 md:px-14">
      <div
        className={`transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          scrolled
            ? "bg-white rounded-full px-2 py-2 flex items-center gap-2 shadow-sm"
            : "w-full max-w-6xl mx-auto flex items-center justify-between relative h-12"
        }`}
      >
        {/* Logo */}
        <a
