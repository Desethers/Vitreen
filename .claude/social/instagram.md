...
- Posée, "luxe calme", pas vendeuse
- Texte court d'accroche en première ligne, puis caption longue OK
- Pas d'emojis (sauf un point typographique style `—` ou `·`)
- Pas de hashtag spam : 3-5 max, en bas de caption
...
- **Galeristes** (35-60 ans), Paris/Bruxelles/Londres/NY, programme contemporain
- **Directeurs de galerie / chargés de communication**
- **Art advisors et marchands privés**
- **Collectionneurs cultivés** (suivent quelques galeries de référence)
- Secondaire : **artistes établis** qui s'auto-représentent en partie
...
- "Lien en bio" (renvoyer vers vitreen.art ou un cas client)
- "DM us" pour les demandes spécifiques galeristes
- Pas de "Cliquez ici", pas de "Profitez maintenant"

## 6. Hashtags (3-5 par post)

- `#contemporaryart` `#galleryview` `#artworld` `#viewingroom` `#privateviewing`
- Éviter les tags génériques de masse (`#art`, `#instaart`)
